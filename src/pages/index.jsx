...
const IndexPage = () => (
    <Layout>
        ...
        <div className="small-container">
            <p>Hi, <h1 className='small-h1'>I am Vova Pilipchatin, a freelance Software Engineer, Web App Deveveloper and constant learner.</h1> I love turning ideas of my client and my own into real-life Digital products. I can help you define a business model, plan out a strategy, architect a solution and develop your Web Application.</p>
